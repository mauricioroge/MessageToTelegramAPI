...
{
    public class UserToServerMQClient: IUserToServerMQClient
    {
        private readonly IModel _model;
        private readonly UserMessagesQueueConfiguration _queueConfiguration;

        public UserToServerMQClient(IRabbitMQContext rabbitMQContext, IOptions<UserMessagesQueueConfiguration> options)
        {
        ...
        IModel IUserToServerMQClient.Model => _model;
